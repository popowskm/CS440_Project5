...
class Records{
    ...
    bool operator<(const Records &r) {
            ...
            // }
            // else {
            //     return emp_record.eid < r.emp_record.eid;
            // }
            bool ret = (dept_record.managerid > 0 ? dept_record.managerid < r.dept_record.managerid: emp_record.eid < r.emp_record.eid);
            return ret;
    }
    
    bool operator==(const Records &r) {
        return emp_record.eid == r.dept_record.managerid;
    }
};
